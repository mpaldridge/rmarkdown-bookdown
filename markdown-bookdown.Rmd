...
If you're already happy with RMarkdown basics and would prefer a detailed guide to Bookdown for the ambitious, Serguei Komissarov's ["Creating lecture notes with Bookdown"](https://minerva.leeds.ac.uk/bbcswebdav/courses/201920_5685_MATH2620/BB-Guide/index.html) is the document for you.

This document was itself written in RMarkdown. You can [read the RMarkdown source file that produced it here](https://github.com/mpaldridge/rmarkdown-bookdown/blob/master/markdown-bookdown.Rmd).
...
This document was written in RMarkdown and "knitted" (compiled) to HTML. This guide concentrates on knitting to HTML, although knitting to a (nonaccessible) LaTeX-style PDF is also fairly easy.
